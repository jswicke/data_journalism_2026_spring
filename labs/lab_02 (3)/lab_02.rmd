...
**I don't see any Mormons on the list, nor does it look like there's any evangelical churches (or megachurches in this case).**
...
md_churches |> 
  mutate(denomination = case_when(
    ...
    str_detect(NAME, "PRESBYT") ~ "Presbyterian",
    str_detect(NAME, "EPISCOPAL") ~ "Episcopal",
    str_detect(NAME, "ORTHODOX") ~ "Orthodox",
    str_detect(NAME, "SYNAGOGUE") ~ "Jewish",
    str_detect(NAME, "UNITARIAN") ~ "Unitarian",
    str_detect(NAME, "PENTECOST") ~ "Pentecostal",
    str_detect(NAME, "ADVENTIST") ~ "Seventh-day Adventist",
    str_detect(NAME, "QUAKER") ~ "Quaker",
    str_detect(NAME, "ISLAMIC|MOSQUE|MUSLIM") ~ "Islamic",
    str_detect(NAME, "SCIENTIST") ~ "Christian Science",
    TRUE ~ "Other"
  )) |>
