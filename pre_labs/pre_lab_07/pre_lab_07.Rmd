...
**Task** Run the following codeblock to load the state and county religion census data. Examine the structure - what columns do you see? **state_code, state name, 2020 population, population rank, etc.**
...
**Task** Run the following code to get 2020 state populations and join them with religion data. Notice that we need to make sure the FIPS codes match in format (both as character types). Which state has the highest percentage of adherents? Which has the lowest? **Utah has the highest. New Hampshire has the lowest.**
