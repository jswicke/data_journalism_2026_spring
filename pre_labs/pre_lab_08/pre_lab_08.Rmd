...
**Task** Run the following code to clean the numeric columns and find the top 10 states by number of congregations. In the space below, explain what each step of the code is doing in English. **The mutate is adding a column named "adherents as percent of population, looking at the number of adherents based on the string value. It then lists the top 10 states. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I don't see anything. It's just gray.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **The bar chart has been formed, but the bottom labels are overlapping and the chart is disorganized.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It is now in size order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The axes flipped.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There's slight shading and readability changes.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **The background became a light blue and the font changed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There is a heading for the chart and new labels. There's also a source.**
...
**Task** Run the following code to load the CARA data. Explain what you see after running the code in the space below. **This gives a bunch of stats and numbers for Catholic populations. Number of priests, deacons, parishes, etc.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A giant line is plummeting.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There are now points for each year on the chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There's now a title, labels, and source. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. Describe any pattern you notice. **There is a positive correlation in this dataset. As the percentage of adherents increases, religious diversty increases.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There is now a line of best fit.**
