...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **The first row is now the header row.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **The column names are terrible and there are still weird ellipses after the state initials. There are also spaces after some of the numbers.**
...
**Task** Run the codeblock below. What else do we need to do? **We need to fix the spaces for some of the top numbers and the states are split up into two rows.**
...
**Task** Run the codeblock below. Look carefully at the results and identify and problems or issues **There are still some NA values**  
...
**Task** Run the codeblock below. Look carefully at the results and identify and remaining problems or issues **The ellipes in the state initials are still there.**  
