...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Zip codes, zip names, figures for the shapes of zip codes**
...
**Task** Run the following code. Describe the output in the space below. **It's a map of Maryland with all of the zip code shapes.**
...
**Task** Run the following code. Describe the output in the space below. **I installed tigris. Not much happened.**
...
**Task** Run the following code. Describe the output in the space below. **The output is a definitive list of every U.S. county**
...
**Task** Run the following code. Describe the output in the space below. **Now, the list is just Maryland counties.**
...
**Task** Run the following code. Describe the output in the space below. **Now, the counties are visualized on a map. The Chesepeake Bay lost its shape.**
...
**Task** Run the following code. Describe the output in the space below. **The 2 maps are now superimposed onto each other, so now we can see both county and zip boundaries.**
...
**Task** Run the following code. Describe the output in the space below. **This is a definitive list of Maryland churches, notably with counties and zips.**
...
**Task** Run the following code. Describe the output in the space below. **This gives us all of the PG county churches.**
...
**Task** Run the following code. Describe the output in the space below. How many churches are in Prince George's County? **There are 2,120 churches in PG County.**
...
**Task** Run the following code. Describe the output in the space below. What spatial patterns do you notice? Which zip codes have the most churches? **Most of the. churches are concentrated in the Southwestern zips. **
...
**Task** Run the following code. Describe the output in the space below. **The output gives us the FIPS code, congregation, and adherents for Maryland counties. As a bonus, we also get the percentage of adherents per county and what church has the largest number of adherents in a county.**
...
**Task** Run the following code. Describe the output in the space below. **This just created the geometric shapes of each Maryland county.**
...
**Task** Run the following code. Describe the output in the space below. **This is the two datasets from above. However, their variable names are all different.**
...
**Task** Run the following code. Describe the output in the space below. **Now, the variable names are the same.**
...
**Task** Run the following code. Describe the output in the space below. **This joined the info together so that the geometric shapes are now with the FIPS codes and adherents as % of population.**
...
**Task** Run the following code. Describe the output in the space below. **This now put the rate in the datasets.**
...
**Task** Run the following code. Describe the output in the space below. **Now, we have a color-coded map based on each county's rate.**
...
**Task** Run the following code. Describe the output in the space below. **The output is now magma-colored, and much easier to distinguish.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Western Maryland seems to have a much higher rate, especially in MoCo, Baltimore, Anne Arundel, and Howard (more urban areas).**
